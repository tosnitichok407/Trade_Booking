...
# yfinance เป็นไลบรารีที่ใช้สำหรับดึงข้อมูลหุ้นจาก Yahoo Finance 
...
if isinstance(df.columns, pd.MultiIndex):
    df.columns = df.columns.get_level_values(0) # อยากได้ทศนิยม 2 ตำแหน่งก็ใช้ round(df["Close"], 2) ได้เลย
